...
const postEndpoint = 'http://127.0.0.1:4041/block/add_transaction'
const getEndpoint = 'http://127.0.0.1:4041/chain'
class Send extends Component {
  ...
  <br/>
  <h3><b>BobCoin</b></h3>
  <h4><b style={{color: '#007bff'}}>Send BobCoin crypto to anyone.</b> </h4>
